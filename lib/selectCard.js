...
function selectCard(allCards, type, performer, target, chosenLevel, usedCardIds, options = {}) {
  ...
  function passes(card, level) {
    ...
    // Step 6: performer genitals — performer must have AT LEAST ONE listed body part
    // e.g. ["vagina","anus"] = either works; ["penis"] = needs a penis
    ...
    // Step 6b: target genitals — target must have AT LEAST ONE listed body part
